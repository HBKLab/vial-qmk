...
#define DEVICE_VER      0x5246
#define MANUFACTURER    HBK_OFFicial
#define PRODUCT         HBK68

/* key matrix size */
#define MATRIX_ROWS 5
#define MATRIX_COLS 15

#define MATRIX_ROW_PINS { A1, A2, A3, B13, A0 }
#define MATRIX_COL_PINS { B6, B7, B8, A4, A5, A6, B0, B12 ,B14, B15, A8, A15, B3, B4, B5 }
