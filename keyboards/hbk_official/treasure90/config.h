...
#define DEVICE_VER      0x1190
#define MANUFACTURER    HBK_OFFicial
#define PRODUCT         Treasure90

/* key matrix size */
#define MATRIX_ROWS 6
#define MATRIX_COLS 17

#define MATRIX_ROW_PINS { B8, A0, A1, B3, B4, B7 }
#define MATRIX_COL_PINS { A2, A3, A4, A5, A6, B0, B1 ,B12, B13, B14, B15 ,A8, A9, A10, A15, B5, B6 }
