...
#define DEVICE_VER      0x2105
#define MANUFACTURER    hbk_official
#define PRODUCT         yuyu105

/* key matrix size */
#define MATRIX_ROWS 6
#define MATRIX_COLS 19

#define MATRIX_ROW_PINS { B0, B1, B10, B11, A6, B13 }
#define MATRIX_COL_PINS { B3, B4, B5, B12, B6, B7, B8 ,A0, A1, A2, A3 ,A4, A5, B14, B15, A8, A9, A10, A15 }
