...
typedef union {
  ...
  struct {
    ...
    bool     rgb_stat :1; //在EEPROM定义变量，记录小灯开关状态
  };
} user_config_t;
...
void rgb_matrix_indicators_user(void) {
  if((user_config.rgb_anim == 0) && (user_config.rgb_stat == 0) ) {  //RGB和小灯都关闭
      rgb_matrix_set_color_all(0, 0, 0);  //所有RGB灯都关闭
  }else if(user_config.rgb_anim == 0){    //关RGB 小灯不关   
  ...
  if (IS_HOST_LED_ON(USB_LED_CAPS_LOCK)) {
    rgb_matrix_set_color(0, 0, 0xff, 0x7e); // LED Index, R, G, B
  }
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
		...
		KC_GRV, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_EQL, KC_NO, 
    ...
    [1] = LAYOUT(
		RGB_STAT, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, RGB_ANIM, 
